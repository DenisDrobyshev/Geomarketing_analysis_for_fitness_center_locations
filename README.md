...
| Категория | Диапазон | Рекомендация |
|-----------|----------|--------------|
| 🟢 Очень высокий | 0.8-1.0 | Идеальные локации |
| 🟡 Высокий | 0.6-0.8 | Отличные возможности |
| 🟠 Средний | 0.4-0.6 | Хороший потенциал |
| 🔴 Низкий | 0.2-0.4 | Требует анализа |
| ⚫ Очень низкий | 0.0-0.2 | Не рекомендуется |
